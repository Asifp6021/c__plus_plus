...
/*
see previous version and see what was the issue coz here we are resolving the issue.

main function accept two arguments.
1. option arguments. int
2. cost pointer char array.
