/*
Each class member function contains a hidden pointer called this. that pointer contains the address of the current object for which the the method is being executed. this also applies to constructors and destructors.

note -> this pointer is special pointer which is maintained by the c++ system.
*/
