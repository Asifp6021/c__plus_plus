...
int main()
{
	...
	*/
	...
	trying to modify the str2 using below variable. but it is not going to change. front_char and back_char have the copy of str2. not the original data that is why it is not going to change. to change original data we can use references.
