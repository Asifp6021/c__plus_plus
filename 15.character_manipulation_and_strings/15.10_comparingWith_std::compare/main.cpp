/*
two strings are equal if they have the same size and if they have the same character in all positions.

if they are not equal comparison will be carried out lexicographically by default <- meas alphabetical order
*/
