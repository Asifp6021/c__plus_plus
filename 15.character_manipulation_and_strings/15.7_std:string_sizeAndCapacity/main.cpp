...
int main()
{
	...
	std::cout << "str1 is empty : " << std::boolalpha << str1.empty() << std::endl; //false
	std::cout << "str2 is empty : " << std::boolalpha << str2.empty() << std::endl; //true
	std::cout << "str3 is empty : " << std::boolalpha << str3.empty() << std::endl; //true
	...
	*/
	...
	/*
	std::string str1 {"Hello World"};
	std::string str2; //it's empty by default we have capacity of 15 character. but size is 0 as it is empty.
