...
int main(){
    ...
    //Use a raw array
    const char * planet1 {"Earth. Where the sky is blue Earth."}; //this memory is wasted
    planet1 = "Earth. Where the sky is blue Earth. Where the sky is blue Earth. Where "; // because pointer pointing at another value.
