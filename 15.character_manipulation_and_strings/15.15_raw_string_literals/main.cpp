/*
we don't have to use escape sequence to achieve desired output or formatting.


 we can use raw string literals which allow us to do easily.

 this feature has been introduced in c++11. you have to always know in which feature is when introduced.
