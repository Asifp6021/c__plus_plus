/*
std::optional <- this feature introduced in c++ 17 help handle output rom function and other things.
*/
...
//    ----------------------------------------------------------------------------------------------------------------                                  
    ...
    // Reading bad data
    // std::cout << letter.value() << std::endl; // Throws exception and crashes program coz it is initilized with null value don't have value.
