/*
we should'nt reference to local variable. it is bad it will crash the program.
*/
...
// passing parameter as pass by value it is making copy of the value we are passing as argument to the function
