// we can't define default arguments on the function definition. if we have already declared prototype. we have to define default arguments on the prototype.

// if prototype has not define then we can define default arguments on the function definition.
...
int main(){
    ...
    //compute(33); //default argument overwritten by the 33 for age.
