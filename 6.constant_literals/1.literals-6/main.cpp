/*
Data that is directly represented in code without going through some other variable stored in memory that is a literal.

A literal is stored directly in your program binary code and the variable isn't

The variable is allocated some space somewhere and the data is copied from literals and stored into memory location that are assigned variable names.
