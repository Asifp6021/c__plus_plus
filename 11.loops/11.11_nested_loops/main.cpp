/*
it's not easy to visually represent data structures with a dimension greater than 3 but now the idea should be building up that up that the more layers of nests you have in your loops, the more dimensions the data you are looping around could represent.

now we are working with the two dimensional data.
