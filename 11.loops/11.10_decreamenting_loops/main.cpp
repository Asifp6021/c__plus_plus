// size_t can only store positive number. if you think after 0 it is going give negative and complete task then you are thinking wrong.
// it will cause infinite loop of positive numbers.
