/*
we have 3 function overload for same logic with different parameter

1. template with pass by value but it compares address not value. <- 3rd choice

2. raw function with pointer <- 1st choice

3. template function with pointer. -> 2nd choice
