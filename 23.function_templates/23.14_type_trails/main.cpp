/*
a mechanism to query information about a (templated) type of compile time.

using this we can make function to work on the types which we want them to work.

static_assert checks at compile time as we learn before
*/
