 ...
 */
    ...
    {
        std::string dog_info = "dog_name : " + m_name + " dog_breed : " + m_breed + " dog_age :" + std::to_string(m_age);
        return dog_info;
    }
    ...
    unsigned int *jumps_per_minute() const
    {
        ...
        return &jumps;
    } // her *jumps_per_minute scope dies when we try to use it. we well be getting error. same with reference.
