/*
arrays allocated on the heap with the new operator. can also use std:nothrow version of new for exception handling.
...
//------------------------------------------------------------------------------------------
   ...
   for( auto s : p_scores1){
       std::cout << "value : " << s << std::endl;
   }  we'cant use ranger for loop on the dynamic array.
   */
